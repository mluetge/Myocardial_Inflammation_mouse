...
#seurat$label[which(seurat$integrated_snn_res.0.4 %in% c(""))] <- "ILCs"
#seurat$label[which(seurat$integrated_snn_res.0.4 %in% c(""))] <- "pDCs"
...
seuratSub <- subset(seurat, age == "4wks", invert=T)
Idents(seuratSub) <- seuratSub$grp
grpVec <- unique(seuratSub$label)
