...
seurat$clusterLabel[which(seurat$seurat_clusters == "2")] <- "Bcells"
seurat$clusterLabel[which(seurat$seurat_clusters == "5")] <- "Tcells"
seurat$clusterLabel[which(seurat$seurat_clusters == "6")] <- "NKcells"
seurat$clusterLabel[which(seurat$seurat_clusters == "7")] <- "Neutrophils"
seurat$clusterLabel[which(seurat$seurat_clusters == "8")] <- "proliferating"
seurat$clusterLabel[which(seurat$seurat_clusters == "9")] <- "DCs"
seurat$clusterLabel[which(seurat$seurat_clusters == "10")] <- "ILCs"
seurat$clusterLabel[which(seurat$seurat_clusters == "12")] <- "pDCs"
seurat$clusterLabel[which(seurat$seurat_clusters == "13")] <- "Basophils"
