...
```{r GSEA clusterprofiler Endo, fig.height=6, fig.width=12}
...
```{r vis summary Endo, fig.height=5, fig.width=10}

## table to select pathways
GOconsDat <- do.call("rbind", GOcons)
write.table(GOconsDat, quote=F, row.names = T, col.names = T, sep= "\t",
            file = paste0(basedir, "/data/GSEA/MuHeart_Endothelial_DE",
            "_GO.txt"))
	

# selGO <- read_tsv(paste0(basedir,"/data/GSEA/selGO_Endothelial.txt"))
